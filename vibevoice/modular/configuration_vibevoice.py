...
class VibeVoiceAcousticTokenizerConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        encoder_ratios: list[int] | None = [8,5,5,4,2,2],
        encoder_depths: str = "3-3-3-3-3-3-8",
        # decoder specific
        decoder_n_filters: int = 32,
        decoder_ratios: list[int] | None = None, # if None, same as encoder
...
class VibeVoiceConfig(PretrainedConfig):
    ...
    def num_hidden_layers(self):
        """Delegate num_hidden_layers to decoder config for cache compatibility"""
        return getattr(self.decoder_config, 'num_hidden_layers', 32)
