            ...
            if "microsoft" in f.read().lower():
                ...
                try:
                    ...
                    if wsl_recorder._windows_ffmpeg_path:
                        ...
                        if devices:
                            print(f"WSL detected with {len(devices)} Windows audio devices available.")
                            return wsl_recorder
                        else:
                            ...
                            print("WSL detected but no Windows audio devices found during enumeration.")
                            print("Attempting to use WSL audio recorder anyway (device enumeration may fail due to permissions).")
                            print("Please check Windows Privacy Settings > Microphone > Allow desktop apps to access your microphone")
                            return wsl_recorder
