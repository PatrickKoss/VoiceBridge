...
class TestTTSDaemonService(unittest.TestCase):
    ...
    def test_handle_generate_hotkey_clipboard_mode(self):
        ...
        self.daemon.current_config = TTSConfig(tts_mode=TTSMode.CLIPBOARD)
        self.mock_orchestrator.process_clipboard_text.return_value = Mock()

        self.daemon._handle_generate_hotkey()

        self.mock_orchestrator.process_clipboard_text.assert_called_once()
    ...
    def test_handle_generate_hotkey_mouse_mode(self):
        ...
        self.mock_orchestrator.process_selected_text.return_value = Mock()

        self.daemon._handle_generate_hotkey()

        self.mock_orchestrator.process_selected_text.assert_called_once()
