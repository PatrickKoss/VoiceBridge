...
class TestTranscriptionCommands:
    ...
    def test_init(self, mock_dependencies):
        ...
        assert commands.transcription_orchestrator == mock_dependencies['transcription_orchestrator']
        assert commands.batch_processing_service == mock_dependencies['batch_processing_service']

    def test_transcribe_file_basic(self, transcription_commands):
        """Test basic file transcription error handling."""
        import typer
        with patch('voicebridge.cli.commands.transcription_commands.typer.echo') as mock_echo:
    ...
    def test_realtime_transcribe_basic(self, transcription_commands):
        ...
        with patch('voicebridge.cli.commands.transcription_commands.typer.echo') as mock_echo:
            with patch('voicebridge.cli.utils.command_helpers.display_error') as mock_display_error:
