...
class TestCLICommands(unittest.TestCase):
    ...
    def test_gpu_status_command_exists(self):
        ...
        self.assertTrue(callable(getattr(system_commands, "gpu_status")))
    ...
    def test_performance_stats_command_exists(self):
        ...
        self.assertTrue(callable(getattr(system_commands, "performance_stats")))
    ...
    def test_sessions_list_command_exists(self):
        ...
        self.assertTrue(callable(getattr(system_commands, "sessions_list")))
    ...
    def test_transcribe_command_exists(self):
        ...
        self.assertTrue(callable(getattr(transcription_commands, "transcribe_file")))
    ...
    def test_audio_info_command_exists(self):
        ...
        self.assertTrue(callable(getattr(audio_commands, "audio_info")))
    ...
    def test_api_status_command_exists(self):
        ...
        self.assertTrue(callable(getattr(api_commands, "api_status")))
    ...
    def test_command_registry_instantiation(self):
        ...
        expected_groups = [
            "speech", "transcription", "tts", "audio", 
            "system", "config", "export", "advanced", "api"
        ]
        
        available_groups = registry.list_command_groups()
        
        for group in expected_groups:
            self.assertIn(group, available_groups, f"Command group '{group}' should be available")
    ...
    def test_command_groups_can_be_retrieved(self):
        ...
        for group_name in test_groups:
            try:
                ...
                self.assertIsNotNone(command_group, f"Command group '{group_name}' should instantiate")
    ...
    def test_system_commands_methods_available(self):
        ...
        expected_methods = [
            "gpu_status", "gpu_benchmark", "performance_stats", 
            "sessions_list", "sessions_resume", "sessions_cleanup", "sessions_delete"
        ]
    ...
    def test_transcription_commands_methods_available(self):
        ...
        expected_methods = [
            "transcribe_file", "batch_transcribe", "listen_resumable", "realtime_transcribe"
        ]
    ...
    def test_audio_commands_methods_available(self):
        ...
        expected_methods = [
            "audio_info", "audio_formats", "audio_convert", "audio_preprocess", "audio_split"
        ]
