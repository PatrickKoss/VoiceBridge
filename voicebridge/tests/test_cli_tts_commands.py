...
class TestTTSCommands:
    ...
    def test_tts_daemon_stop(self, tts_commands):
        ...
        mock_daemon = Mock()
        mock_daemon.is_daemon_running.return_value = True  # Make it think daemon is running
    ...
    def test_daemon_modes_coverage(self, tts_commands):
        ...
        mock_daemon.is_daemon_running.side_effect = [False, True, False, True]  # alternating for while loop
        tts_commands.tts_daemon_service = mock_daemon
