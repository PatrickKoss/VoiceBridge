...
class E2EAssertions:
    ...
    def assert_command_success(result: CLIResult, 
                             ...
                             expected_in_stderr: Optional[List[str]] = None):
    ...
    def assert_json_output(result: CLIResult, 
                          ...
                          expected_values: Optional[Dict[str, Any]] = None) -> Dict:
    ...
    @staticmethod
    def assert_audio_file_created(file_path: Union[str, Path],
    ...
    def assert_configuration_output(result: CLIResult,
                                   expected_config_keys: Optional[List[str]] = None):
